...
$ttshowcase_options = array(
		...
		'args' =>  array( 
	        ...
	        'query_var' => true,
	        'can_export' => true,
	        'rewrite' => array('slug' => __('testimonial','URL slug','ttshowcase')),
		...
		'meta_boxes' => array(
			...
			'case_study_info' => array(
					'title' => __('Case Study Page Content','ttshowcase'),
				...
				'sections' => array(
						...
						'fields' => array(
							...
							*/
							...
							'thankyou' => array(
								...
								'type' => 'wysiwyg',
								'default' => __('Thank you for submitting your testimonial! It is now awaiting approval from the site admnistator. Thank you!','ttshowcase'),
							) ,

							'thankyou_url' => array(
								'label' => __('Confirmation Page','ttshowcase'),
								'description' => __('If you want the user to be redirected to a specific URL instead of displaying the above message, place the URL here. If there is an URL in this field the message above will be ignored and the user will be redirected to the page of have set here.','ttshowcase'),
								'type' => 'text',
							...
							'loggedonly' => array(
								...
								'type' => 'wysiwyg',
								'default' => __('You need to be a registred user to submit entries.','ttshowcase'),
							) ,
							'sendemail' => array(
					...
					'advanced_settings' => array(
						...
						'fields' => array(
							...
							'load_css_form' => array(
								'label' => __('Load Custom CSS for Forms','ttshowcase'),
								'description' => __('If active, the above custom CSS will also load on pages where the frontend submission form is being used','ttshowcase'),
								'type' => 'checkbox',
								'default' => 'off',
								'value' => 'on'
							...
							'quote_elements' => array(
								...
								'description' => __('Which elements to display inside quote block (Inside Speech Bubble).<br> Available template tags: {quote},{read_more},{review_title},{author},{stars},{date},{subtitle}','ttshowcase'),
								'type' => 'text',
								'size' => 'regular',
							...
							'info_elements' => array(
								...
								'description' => __('Which elements to display inside info block (Together with Image).<br> Available template tags: {quote},{read_more},{review_title},{author},{stars},{date},{subtitle}','ttshowcase'),
								'type' => 'text',
								'size' => 'regular',
								'default' => '{author}{subtitle}{stars}{date}'
								)
						)
					),
					'help_settings' => array(
