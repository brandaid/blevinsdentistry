<?php
/*
Based on the code by Jake Goldman, 10up -  http://10up.com/plugins/simple-page-ordering-wordpress/
Licenced under GPLv2
*/

if ( !class_exists( 'cmshowcase_ordering' ) ) {
	class cmshowcase_ordering {
		...
		public static function wp() {
			if ( 0 === strpos( get_query_var('orderby'), 'menu_order' ) ) {
				...
				$script_name =  '/includes/js/ordering.js';
				wp_enqueue_script( 'cmshowcase-ordering', plugins_url( $script_name, DIRNAME(__FILE__) ), array('jquery-ui-sortable'), '2.1', true );
				wp_enqueue_style( 'cmshowcase-admin', plugins_url( '/includes/css/admin.css', DIRNAME(__FILE__) ) );
			}
		...
		public static function sort_by_order_link( $views ) {
			...
			if(get_query_var('orderby') != 'menu_order') {
				...
				$views['byorder'] = __("Drag & Drop Ordering Activated", 'ttshowcase');
