...
include_once( 'facebook_sdk-v4-4.0/Facebook/HttpClients/FacebookHttpable.php' );
include_once( 'facebook_sdk-v4-4.0/Facebook/HttpClients/FacebookCurl.php' );
include_once( 'facebook_sdk-v4-4.0/Facebook/HttpClients/FacebookCurlHttpClient.php' );
include_once( 'facebook_sdk-v4-4.0/Facebook/Entities/AccessToken.php' );

include_once( 'facebook_sdk-v4-4.0/Facebook/FacebookSession.php' );
include_once( 'facebook_sdk-v4-4.0/Facebook/FacebookRedirectLoginHelper.php' );
include_once( 'facebook_sdk-v4-4.0/Facebook/FacebookRequest.php' );
include_once( 'facebook_sdk-v4-4.0/Facebook/FacebookResponse.php' );
include_once( 'facebook_sdk-v4-4.0/Facebook/FacebookSDKException.php' );
include_once( 'facebook_sdk-v4-4.0/Facebook/FacebookRequestException.php' );
include_once( 'facebook_sdk-v4-4.0/Facebook/FacebookOtherException.php' );
include_once( 'facebook_sdk-v4-4.0/Facebook/FacebookAuthorizationException.php' );
include_once( 'facebook_sdk-v4-4.0/Facebook/GraphObject.php' );
include_once( 'facebook_sdk-v4-4.0/Facebook/GraphSessionInfo.php' );
