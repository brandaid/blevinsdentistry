...
function gg_dropbox_access_token($gid, $authCode) {
	require_once(GG_DIR . '/classes/dropbox-sdk-php-1.1.4/lib/Dropbox/autoload.php');
	
	$appInfo = \Dropbox\AppInfo::loadFromJsonFile(GG_DIR . '/classes/dropbox-sdk-php-1.1.4/lcweb_config.json');
