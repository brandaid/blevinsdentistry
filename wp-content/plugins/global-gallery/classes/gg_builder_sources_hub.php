...
class gg_builder_hub {
	...
	public function spec_opt($params = false) {
		...
		if($this->src != 'wp') {
			...
			// FEB 2017 - DROPBOX WARNING!
			if($this->src == 'dropbox') {
				$code = '<div style="padding: 8px 12px; border: 1px solid #fcc1c1; background-color: #ffefef; border-left-width: 8px;">As of <strong>March 15 2017</strong>, Dropbox <a href="https://www.dropbox.com/help/16" target="_blank">ended public folder service</a>. Then <strong>won\'t be possible</strong> to fetch images from this source.
				
			<br/><br/>
			
			Source is still visible here to let you check which images were added and migrate to another service, but will be removed before summer.</div>';	
			}
			///////////////////////////////////
