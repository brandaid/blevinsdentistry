<?php
/**
 * Template Name: Request Appointment Page Template
 *
 */
			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<div class="row flex-row">
					<div class="col-sm-6 flex-col flex-col-color">
						...
						<p>We can't wait to help you create your dream smile!</p>
						<?php echo do_shortcode( '[contact-form-7 id="4640" title="Request an Appointment"]' ); ?>
					</div>
